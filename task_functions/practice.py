...
def guitar_loop_note():
    ...
    d.clear()
    d.print(
        f"The note you will practice is {note} and the metronome is set to {bpm} bpm.\n\n"
    )
    time.sleep(0.5)
    d.print(
        "The exercise consists of looping the note in each string from the fret 0 to the fret 11.\n\n"
    )
    time.sleep(0.5)
    d.print("You will start from the 1st string until you reach the 6th string.\n\n")
    time.sleep(0.5)
    d.print(
        "If you make a mistake, wait for the next loop to start again from the correct beat.\n\n"
    )
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    d.print(
        "The pick goes up for strings 2, 4, and 6, and down for strings 1, 3, and 5.\n\n"
    )
    time.sleep(0.5)
...
def solve_leetcode_problem():
    ...
    time.sleep(0.5)
    d.print(
        "You can also select today's Daily Coding Challenge or a random problem.\n\n"
    )
    ...
    d.clear()
    d.print(
        "Do a first read of the problem statement and constraints to get a general sense of the problem.\n\n"
    )
    d.input()
    d.clear()
    d.print(
        "(Optional) Go to the Solutions section to read the most popular solutions.\n\n"
    )
    time.sleep(0.5)
    d.print(
        "It's okey to do so. We are here to learn efficient algorithms and data structures, not to reinvent the wheel.\n\n"
    )
    time.sleep(0.5)
    d.print(
    ...
    time.sleep(0.5)
    d.print(
        "At this stage, you are still allowed to look at the Solutions but not the code written in the language you are using.\n\n"
    )
    time.sleep(0.5)
    d.print(
        "You can also search infroamtion on the internet or use other tools to help you solve the problem as long as you don't read code written in the language you are using.\n\n"
    )
    time.sleep(0.5)
    d.print(
        "Think about the properties of the class and the helper methods you will need.\n\n"
    )
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    d.print(
        "If you have learned something new, like a new data structure or algorithm, write it down in your preferred reference storing system.\n\n"
    )
...
def take_exam():
    d.print(
        "Open the skill_builder_exams main notebook, select the exam, and answer all the questions.\n\n"
    )
    d.open_webpage(
        "https://colab.research.google.com/github/GenaroHacker/skill_builder_exams/blob/main/main.ipynb"
    )
    d.input()
