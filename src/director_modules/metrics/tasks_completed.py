...
def plot_event_schedule(db_path, days_range=None):
    ...
    for date in unique_dates:
        ...
        for function_name in day_events['function_name'].unique():
            ...
            for start, end in zip(start_times, end_times):
                ...
                task_durations[function_name] = task_durations.get(function_name, 0) + duration
    ...
    for date in unique_dates:
        ...
        for start, end, function_name in tasks:
            if function_name in colors:
                ...
                plt.bar(date, end_hour - start_hour, bottom=start_hour, color=colors[function_name], edgecolor='grey', label=function_name)
    ...
    plt.legend(by_label.values(), by_label.keys(), loc='center left', bbox_to_anchor=(1, 0.5), ncol=1)
